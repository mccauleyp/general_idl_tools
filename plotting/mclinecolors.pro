;+
; NOTE: This is a modified version of the LINECOLORS routine that adds 4 additional colors
;       meant to be a bit easier for colorblind users to distinguish. 
;
; file LINECOLORS.PRO
;
...
;       06-Jun-2017 - Added colorblind friendly colors (14-17) - Patrick McCauley
;-

pro mclinecolors, mycol_r=mycol_r, mycol_g=mycol_g, mycol_b=mycol_b, $
...
;
  ...
  distinct_r = [0,128,255,255,255,255,128,  0,  0,  0,  0,  0,255,128,  0,204,230,213]
  distinct_g = [0,  0,  0,  0,128,255,128,255,128,255,  0,  0,  0,  0,114,121,159,094]
  distinct_b = [0,  0,  0,128,  0,  0,  0,  0,  0,255,255,128,255,128,178,167,  0,000]
